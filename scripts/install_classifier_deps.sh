...
pip install --upgrade scikit-learn evaluate accelerate datasets

echo "---"
python -c "import sklearn, evaluate, accelerate, datasets; print('OK: scikit-learn', sklearn.__version__, '| evaluate', evaluate.__version__, '| accelerate', accelerate.__version__, '| datasets', datasets.__version__)"
